    ...
    <div class="row">
        ...
        <div class="col-md-8">
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${news.comments}" var="comment">
                            <tr>
                                ...
                                <td>${f:formatLocalDateTime(comment.created, 'MM-dd-yyyy HH:mm')}</td>
            ...
            <security:authorize access="hasAuthority('create_comment')">
                ...
                <div class="row">
                    <h5 class="label-info">on ${f:formatLocalDateTime(news.created, 'MM-dd-yyyy HH:mm')}</h5>
                </div>
                <div class="news">
                        ${news.content}
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form:form action="${app_entry_path}/news/${news.id}/comments" modelAttribute="comment"
                                   method="post">
                            <form:errors path="content" cssClass="alert-danger" element="div"/>
                            <div>COMMENT ID HERE??? <c:out value="${comment.id}"/></div>
                            <div class="form-group">
