...
<head>
    ...
    <title>Update Items Discounts</title>
</head>
<body>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <security:authorize access="hasAuthority('update_discount_item')">
                        <form:form action="${app_entry_path}/items/discounts/update" modelAttribute="discountDetails" method="post">
                            <form:errors path="minPrice" cssClass="container-fluid" element="div"/>
                            <div class="form-group">
                                <form:label path="minPrice">Min item price range value</form:label>
                                <form:input type="number" path="minPrice" step="0.01" min="199.99" maxlength="99999.99" class="form-control" id="minPrice"/>
                            </div>
                            <form:errors path="maxPrice" cssClass="container-fluid" element="div"/>
                            <div class="form-group">
                                <form:label path="maxPrice">Max item price range value</form:label>
                                <form:input type="number" path="maxPrice" step="0.01" min="199.99" maxlength="99999.99" class="form-control" id="maxPrice"/>
                            </div>
                            <div class="form-group">
